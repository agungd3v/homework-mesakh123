                ...
                {data.length > 0 && data.map((ab: any, index: number) => {
                  return (
                    <tr key={index}>
                      ...
                      <td>
                        {ab.status == 1 && <span className="py-1.5 px-3 rounded text-white bg-blue-400">Pending</span>}
                        {ab.status == 2 && <span className="py-1.5 px-3 rounded text-white bg-yellow-400">Process</span>}
                        {ab.status == 3 && <span className="py-1.5 px-3 rounded text-white bg-green-400">Complete</span>}
                      </td>
                    </tr>
                  );
                })}
